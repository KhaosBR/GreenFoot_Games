...
public class MyWorld extends World
{
    ...
    void Invocar(){
        ...
        addObject(new Block(), 575, 500);
        addObject(new Block(), 525, 500);
        //wall left side
        ...
        addObject(new Block(), 300, 300);
        addObject(new Block(), 300, 250);
        addObject(new Block(), 300, 350);
        //wall right side
        ...
        addObject(new Block(), 799, 300);
        addObject(new Block(), 799, 250);
        addObject(new Block(), 799, 350);
